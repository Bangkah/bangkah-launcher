...
class EnvironmentService
{
    ...
    public function configureDatabase(string $targetPath, string $dbType, bool $docker = false): void
    {
        ...
        $this->updateEnvExample($targetPath, 'DB_CONNECTION', $dbType === 'postgresql' || $dbType === 'postgres' ? 'pgsql' : 'mysql');
        $this->updateEnvExample($targetPath, 'DB_HOST', $host);
        $this->updateEnvExample($targetPath, 'DB_PORT', $dbType === 'postgresql' || $dbType === 'postgres' ? '5432' : '3306');
