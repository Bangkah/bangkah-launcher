...
class DockerService
{
    ...
    public function generateCompose(string $targetPath, array $opts): void
    {
        ...
        // ensure Dockerfile exists based on options
        ...
        if ($useNginx) {
            ...
            $this->files->copy(base_path('resources/starter/nginx/nginx.conf.stub'), $targetPath.'/docker/nginx/nginx.conf');
        }
    }
...
# CLI target for php artisan / dev server
